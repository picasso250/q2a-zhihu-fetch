...
qa_register_plugin_module('page', 'qa-zhihu-fetch-page.php', 'qa_zhihu_fetch_page', 'Zhihu Fetch Page');
qa_register_plugin_phrases('qa-zhihu-fetch-lang-*.php', 'zhihu_fetch_page');
